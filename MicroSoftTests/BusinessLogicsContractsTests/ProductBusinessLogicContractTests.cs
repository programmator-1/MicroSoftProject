...
internal class ProductBusinessLogicContractTests
{
    ...
    public void GetAllProducts_ReturnListOfRecords_Test()
    {
        ...
        {
            new(Guid.NewGuid().ToString(), "name 1", ProductType.OS, Guid.NewGuid().ToString(), 100, 10, false),
            new(Guid.NewGuid().ToString(), "name 2", ProductType.OS, Guid.NewGuid().ToString(), 100, 10, true),
            new(Guid.NewGuid().ToString(), "name 3", ProductType.OS, Guid.NewGuid().ToString(), 100, 10, false),
        };
    ...
    public void GetProductHistoryByProduct_ReturnListOfRecords_Test()
    {
        ...
        {
            new(Guid.NewGuid().ToString(), 100, 10),
            new(Guid.NewGuid().ToString(), 150, 15),
            new(Guid.NewGuid().ToString(), 100, 10),
        };
    ...
    public void GetProductByData_GetById_ReturnRecord_Test()
    {
        ...
        var record = new ProductDataModel(id, "name", ProductType.OS, Guid.NewGuid().ToString(), 100, 10, false);
    ...
    public void GetProductByData_GetByName_ReturnRecord_Test()
    {
        //Arrange 
        var name = "name";
        var record = new ProductDataModel(Guid.NewGuid().ToString(), name, ProductType.OS, Guid.NewGuid().ToString(), 100, 10, false);
    ...
    public void InsertProduct_CorrectRecord_Test()
    {
        ...
        _productStorageContract.Setup(x => x.AddElement(It.IsAny<ProductDataModel>()))
          .Callback((ProductDataModel x) => {
              ...
              x.ManufacturerId == record.ManufacturerId && x.ProductPrice == record.ProductPrice && 
              x.InstallPrice == record.InstallPrice && x.IsDeleted == record.IsDeleted;
          });
        //Act 
    ...
    x.AddElement(It.IsAny<ProductDataModel>())).Throws(new ElementExistsException("Data", "Data"));
        //Act&Assert 
        Assert.That(() => _productBusinessLogicContract.InsertProduct(new(Guid.NewGuid().ToString(), "name", ProductType.OS, Guid.NewGuid().ToString(), 100, 10, false)), Throws.TypeOf<ElementExistsException>());
        _productStorageContract.Verify(x => x.AddElement(It.IsAny<ProductDataModel>()), Times.Once);
    }
    ...
    {
        //Act&Assert 
        Assert.That(() => _productBusinessLogicContract.InsertProduct(new ProductDataModel("id", "name", ProductType.OS, Guid.NewGuid().ToString(), 100, 10, false)), Throws.TypeOf<ValidationException>());
        _productStorageContract.Verify(x => x.AddElement(It.IsAny<ProductDataModel>()), Times.Never);
    }
    ...
    public void InsertProduct_StorageThrowError_ThrowException_Test()
    {
        //Arrange 
        _productStorageContract.Setup(x =>
    x.AddElement(It.IsAny<ProductDataModel>())).Throws(new StorageException(new InvalidOperationException()));
        //Act&Assert 
        Assert.That(() => _productBusinessLogicContract.InsertProduct(new(Guid.NewGuid().ToString(), "name", ProductType.OS, Guid.NewGuid().ToString(), 100, 10, false)), Throws.TypeOf<StorageException>());
        _productStorageContract.Verify(x => x.AddElement(It.IsAny<ProductDataModel>()), Times.Once);
    }
    ...
    public void UpdateProduct_RecordWithIncorrectData_ThrowException_Test()
    {
        ...
        //Act&Assert 
        Assert.That(() =>  _productBusinessLogicContract.UpdateProduct(new(Guid.NewGuid().ToString(), "name", ProductType.OS, Guid.NewGuid().ToString(), 100, 10, false)), Throws.TypeOf<ElementNotFoundException>());
        _productStorageContract.Verify(x => x.UpdElement(It.IsAny<ProductDataModel>()), Times.Once);
    }
    ...
    public void UpdateProduct_RecordWithExistsData_ThrowException_Test()
    {
        ...
        //Act&Assert 
        Assert.That(() => _productBusinessLogicContract.UpdateProduct(new(Guid.NewGuid().ToString(), "anme", ProductType.OS, Guid.NewGuid().ToString(), 100, 10, false)), Throws.TypeOf<ElementExistsException>());
        _productStorageContract.Verify(x => x.UpdElement(It.IsAny<ProductDataModel>()), Times.Once);
    }
    ...
    {
        //Act&Assert 
        Assert.That(() => _productBusinessLogicContract.UpdateProduct(new ProductDataModel("id", "name", ProductType.OS, Guid.NewGuid().ToString(), 100, 10, false)), Throws.TypeOf<ValidationException>());
        _productStorageContract.Verify(x => x.UpdElement(It.IsAny<ProductDataModel>()), Times.Never);
    }
    ...
    public void UpdateProduct_StorageThrowError_ThrowException_Test()
    {
        ...
        //Act&Assert 
        Assert.That(() => _productBusinessLogicContract.UpdateProduct(new(Guid.NewGuid().ToString(), "name", ProductType.OS, Guid.NewGuid().ToString(), 100, 10, false)), Throws.TypeOf<StorageException>());
        _productStorageContract.Verify(x => x.UpdElement(It.IsAny<ProductDataModel>()), Times.Once);
    }
    ...
    public void DeleteProduct_RecordWithIncorrectId_ThrowException_Test()
    {
        ...
        //Act&Assert 
        Assert.That(() =>
    _productBusinessLogicContract.DeleteProduct(Guid.NewGuid().ToString()), Throws.TypeOf<ElementNotFoundException>());
        _productStorageContract.Verify(x => x.DelElement(It.IsAny<string>()), Times.Once);
    }
