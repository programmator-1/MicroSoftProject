...
internal class WorkerBusinessLogicContractTests
{
    ...
    public void GetAllWorkers_ReturnListOfRecords_Test()
    {
        ...
        {
            new(Guid.NewGuid().ToString(), "fio 1", Guid.NewGuid().ToString(), DateTime.Now.AddYears(-16).AddDays(-1), DateTime.Now, "test.test.com", false),
            new(Guid.NewGuid().ToString(), "fio 2", Guid.NewGuid().ToString(), DateTime.Now.AddYears(-16).AddDays(-1), DateTime.Now, "test.test.com", true),
            new(Guid.NewGuid().ToString(), "fio 3", Guid.NewGuid().ToString(), DateTime.Now.AddYears(-16).AddDays(-1), DateTime.Now, "test.test.com", false),
        };
    ...
    public void GetWorkerByData_GetById_ReturnRecord_Test()
    {
        ...
        var record = new WorkerDataModel(id, "fio", Guid.NewGuid().ToString(), DateTime.Now.AddYears(-16).AddDays(-1), DateTime.Now, "test.test.com", false);
    ...
    public void GetWorkerByData_GetByFio_ReturnRecord_Test()
    {
        //Arrange 
        var fio = "fio";
        var record = new WorkerDataModel(Guid.NewGuid().ToString(), fio, Guid.NewGuid().ToString(), DateTime.Now.AddYears(-16).AddDays(-1), DateTime.Now, "test.test.com", false);
    ...
    public void InsertWorker_CorrectRecord_Test()
    {
        ...
        var flag = false;
        var record = new WorkerDataModel(Guid.NewGuid().ToString(), "fio", Guid.NewGuid().ToString(), DateTime.Now.AddYears(-16).AddDays(-1), DateTime.Now, "test@test.com", false);
        _workerStorageContract.Setup(x => x.AddElement(It.IsAny<WorkerDataModel>())).Callback((WorkerDataModel x) => {
              flag = x.Id == record.Id && x.FIO == record.FIO && x.PostId == record.PostId && x.BirthDate == record.BirthDate && 
            x.EmploymentDate == record.EmploymentDate && x.Email == record.Email && x.IsDeleted == record.IsDeleted;
        });
        //Act 
    ...
    public void InsertWorker_RecordWithExistsData_ThrowException_Test()
    {
        ...
        //Act&Assert 
        Assert.That(() => _workerBusinessLogicContract.InsertWorker(new(Guid.NewGuid().ToString(), "fio", Guid.NewGuid().ToString(), DateTime.Now.AddYears(-16).AddDays(-1), DateTime.Now, "test@test.com", false)), Throws.TypeOf<ElementExistsException>());
        _workerStorageContract.Verify(x => x.AddElement(It.IsAny<WorkerDataModel>()), Times.Once);
    }
    ...
    {
        //Act&Assert 
        Assert.That(() => _workerBusinessLogicContract.InsertWorker(new WorkerDataModel("id", "fio", Guid.NewGuid().ToString(), DateTime.Now.AddYears(-16).AddDays(-1), DateTime.Now, "test@test.com", false)), Throws.TypeOf<ValidationException>());
        _workerStorageContract.Verify(x => x.AddElement(It.IsAny<WorkerDataModel>()), Times.Never);
    }
    ...
    public void InsertWorker_StorageThrowError_ThrowException_Test()
    {
        ...
        //Act&Assert 
        Assert.That(() => _workerBusinessLogicContract.InsertWorker(new(Guid.NewGuid().ToString(), "fio", Guid.NewGuid().ToString(), DateTime.Now.AddYears(-16).AddDays(-1), DateTime.Now, "test@test.com", false)), Throws.TypeOf<StorageException>());
        _workerStorageContract.Verify(x => x.AddElement(It.IsAny<WorkerDataModel>()), Times.Once);
    }
    ...
    public void UpdateWorker_CorrectRecord_Test()
    {
        ...
        var flag = false;
        var record = new WorkerDataModel(Guid.NewGuid().ToString(), "fio", Guid.NewGuid().ToString(), DateTime.Now.AddYears(-16).AddDays(-1), DateTime.Now, "test@test.com", false);
        _workerStorageContract.Setup(x => x.UpdElement(It.IsAny<WorkerDataModel>())).Callback((WorkerDataModel x) => {   
            flag = x.Id == record.Id && x.FIO == record.FIO && x.PostId == record.PostId && x.BirthDate == record.BirthDate &&
            x.EmploymentDate == record.EmploymentDate && x.Email == record.Email && x.IsDeleted == record.IsDeleted;
          });
        //Act 
    ...
    public void UpdateWorker_RecordWithIncorrectData_ThrowException_Test()
    {
        ...
        //Act&Assert 
        Assert.That(() => _workerBusinessLogicContract.UpdateWorker(new(Guid.NewGuid().ToString(), "fio", Guid.NewGuid().ToString(), DateTime.Now.AddYears(-16).AddDays(-1), DateTime.Now, "test@test.com", false)), Throws.TypeOf<ElementNotFoundException>());
        _workerStorageContract.Verify(x => x.UpdElement(It.IsAny<WorkerDataModel>()), Times.Once);
    }
    ...
    {
        //Act&Assert 
        Assert.That(() => _workerBusinessLogicContract.UpdateWorker(new WorkerDataModel("id", "fio", Guid.NewGuid().ToString(), DateTime.Now.AddYears(-16).AddDays(-1), DateTime.Now, "test@test.com", false)), Throws.TypeOf<ValidationException>());
        _workerStorageContract.Verify(x => x.UpdElement(It.IsAny<WorkerDataModel>()), Times.Never);
    }
    ...
    public void UpdateWorker_StorageThrowError_ThrowException_Test()
    {
        ...
        //Act&Assert 
        Assert.That(() => _workerBusinessLogicContract.UpdateWorker(new(Guid.NewGuid().ToString(), "fio", Guid.NewGuid().ToString(), DateTime.Now.AddYears(-16).AddDays(-1), DateTime.Now, "test@test.com", false)), Throws.TypeOf<StorageException>());
        _workerStorageContract.Verify(x => x.UpdElement(It.IsAny<WorkerDataModel>()), Times.Once);
    }
