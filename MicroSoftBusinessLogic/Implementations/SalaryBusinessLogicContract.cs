...
{
    internal class SalaryBusinessLogicContract(ISalaryStorageContract salaryStorageContract, IInstallStorageContract installStorageContract, IPostStorageContract postStorageContract, IWorkerStorageContract workerStorageContract, ILogger logger)
        : ISalaryBusinessLogicContract
    {
        ...
        public void CalculateSalaryByMounth(DateTime date)
        {
            ...
            {
                var sales = _installStorageContract.GetList(startDate, finishDate, workerId: worker.Id)?.Sum(x => x.ProductPrice + x.InstallPrice) ?? throw new NullListException();
